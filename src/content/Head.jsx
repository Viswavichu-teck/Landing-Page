                ...
                <div className="row justify-content-center">
                    <div className="col-xl-6">
                        <div className="text-center text-white">
                            ...
                            <!-- to get an API token!--> */}
                            <form className="form-subscribe" id="contactForm" data-sb-form-api-token="d36f777e-da11-40d6-a4a1-09f746f15558">
                                {/* <!-- Email address input--> */}
                                <div className="row">
                                    <div className="col">
                                    ...
                                    <div className="col-auto">
                                        <button className="btn btn-primary btn-lg" onClick={SubmitEvent}>Submit</button></div>
                                </div>
